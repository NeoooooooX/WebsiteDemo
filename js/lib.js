'use strict';
(self.webpackChunk_sac_ = self.webpackChunk_sac_ || []).push([
  [698],
  {
    9717: (e, t, i) => {
      i.d(t, { V: () => a });
      ...
      class a extends r.T {
        constructor() {
          super(),
            (this.isCamera = !0),
            (this.type = 'Camera'),
            (this.matrixWorldInverse = new n.y()),
            (this.projectionMatrix = new n.y()),
            (this.projectionMatrixInverse = new n.y());
        }
        copy(e, t) {
          return (
            super.copy(e, t),
    ...
    8695: (e, t, i) => {
      ...
      class a extends n.V {
        ...
        getFocalLength() {
          const e = Math.tan(0.5 * r.qW * this.fov);
          return (0.5 * this.getFilmHeight()) / e;
        }
        getEffectiveFOV() {
          return 2 * r.I3 * Math.atan(Math.tan(0.5 * r.qW * this.fov) / this.zoom);
        }
        getFilmWidth() {
        ...
        updateProjectionMatrix() {
          const e = this.near;
          let t = (e * Math.tan(0.5 * r.qW * this.fov)) / this.zoom,
            i = 2 * t,
            n = this.aspect * i,
            a = -0.5 * n;
          const s = this.view;
    ...
    3107: (e, t, i) => {
      ...
      class c {
        ...
        applyMatrix3(e) {
          if (2 === this.itemSize)
            for (let t = 0, i = this.count; t < i; t++)
              l.fromBufferAttribute(this, t), l.applyMatrix3(e), this.setXY(t, l.x, l.y);
          else if (3 === this.itemSize)
            for (let t = 0, i = this.count; t < i; t++)
              o.fromBufferAttribute(this, t), o.applyMatrix3(e), this.setXYZ(t, o.x, o.y, o.z);
          return this;
        }
        applyMatrix4(e) {
          for (let t = 0, i = this.count; t < i; t++)
            o.fromBufferAttribute(this, t), o.applyMatrix4(e), this.setXYZ(t, o.x, o.y, o.z);
          return this;
        }
        applyNormalMatrix(e) {
          for (let t = 0, i = this.count; t < i; t++)
            o.fromBufferAttribute(this, t), o.applyNormalMatrix(e), this.setXYZ(t, o.x, o.y, o.z);
          return this;
        }
        transformDirection(e) {
          for (let t = 0, i = this.count; t < i; t++)
            o.fromBufferAttribute(this, t), o.transformDirection(e), this.setXYZ(t, o.x, o.y, o.z);
          return this;
        }
        set(e) {
        ...
        setXY(e, t, i) {
          return (
            (e *= this.itemSize),
            this.normalized && ((t = (0, a.Fv)(t, this.array)), (i = (0, a.Fv)(i, this.array))),
            (this.array[e + 0] = t),
            (this.array[e + 1] = i),
            this
          );
        ...
        setXYZ(e, t, i, n) {
          return (
            (e *= this.itemSize),
            this.normalized &&
              ((t = (0, a.Fv)(t, this.array)), (i = (0, a.Fv)(i, this.array)), (n = (0, a.Fv)(n, this.array))),
            (this.array[e + 0] = t),
            (this.array[e + 1] = i),
            (this.array[e + 2] = n),
            this
        ...
        setXYZW(e, t, i, n, r) {
          return (
            (e *= this.itemSize),
            this.normalized &&
              ((t = (0, a.Fv)(t, this.array)),
              (i = (0, a.Fv)(i, this.array)),
              (n = (0, a.Fv)(n, this.array)),
              (r = (0, a.Fv)(r, this.array))),
            (this.array[e + 0] = t),
            (this.array[e + 1] = i),
            (this.array[e + 2] = n),
            (this.array[e + 3] = r),
    ...
    8674: (e, t, i) => {
      ...
      class y extends s.p {
        ...
        setFromPoints(e) {
          ...
          return this.setAttribute('position', new o.a$(t, 3)), this;
        }
        computeBoundingBox() {
          ...
          if (e && e.isGLBufferAttribute)
            this.boundingBox.set(new n.P(-1 / 0, -1 / 0, -1 / 0), new n.P(1 / 0, 1 / 0, 1 / 0));
          else {
            if (void 0 !== e) {
              if ((this.boundingBox.setFromBufferAttribute(e), t))
                for (let e = 0, i = t.length; e < i; e++) {
                  const i = t[e];
                  v.setFromBufferAttribute(i),
                    this.morphTargetsRelative
                      ? (M.addVectors(this.boundingBox.min, v.min),
                        this.boundingBox.expandByPoint(M),
                        M.addVectors(this.boundingBox.max, v.max),
                        this.boundingBox.expandByPoint(M))
                      : (this.boundingBox.expandByPoint(v.min), this.boundingBox.expandByPoint(v.max));
                }
        ...
        computeBoundingSphere() {
          ...
          if (e && e.isGLBufferAttribute) this.boundingSphere.set(new n.P(), 1 / 0);
            ...
            if ((v.setFromBufferAttribute(e), t))
              for (let e = 0, i = t.length; e < i; e++) {
                const i = t[e];
                x.setFromBufferAttribute(i),
                  this.morphTargetsRelative
                    ? (M.addVectors(v.min, x.min), v.expandByPoint(M), M.addVectors(v.max, x.max), v.expandByPoint(M))
                    : (v.expandByPoint(x.min), v.expandByPoint(x.max));
              }
            v.getCenter(i);
            let n = 0;
            for (let t = 0, r = e.count; t < r; t++)
              M.fromBufferAttribute(e, t), (n = Math.max(n, i.distanceToSquared(M)));
            if (t)
              for (let r = 0, a = t.length; r < a; r++) {
                const a = t[r],
                  s = this.morphTargetsRelative;
                for (let t = 0, r = a.count; t < r; t++)
                  M.fromBufferAttribute(a, t),
                    s && (_.fromBufferAttribute(e, t), M.add(_)),
                    (n = Math.max(n, i.distanceToSquared(M)));
              }
        ...
        computeTangents() {
          ...
          const h = this.getAttribute('tangent').array,
            u = [],
            d = [];
          for (let e = 0; e < c; e++) (u[e] = new n.P()), (d[e] = new n.P());
          const p = new n.P(),
            f = new n.P(),
            m = new n.P(),
            g = new r.F(),
          ...
          function y(e, t, i) {
            ...
            isFinite(n) &&
              (x.copy(f).multiplyScalar(v.y).addScaledVector(m, -_.y).multiplyScalar(n),
              M.copy(m).multiplyScalar(_.x).addScaledVector(f, -v.x).multiplyScalar(n),
              u[e].add(x),
              u[t].add(x),
              u[i].add(x),
              d[e].add(M),
          ...
          let S = this.groups;
          0 === S.length && (S = [{ start: 0, count: i.length }]);
          for (let e = 0, t = S.length; e < t; ++e) {
            const t = S[e],
              n = t.start;
            for (let e = n, r = n + t.count; e < r; e += 3) y(i[e + 0], i[e + 1], i[e + 2]);
          }
          const b = new n.P(),
            w = new n.P(),
            T = new n.P(),
          ...
          for (let e = 0, t = S.length; e < t; ++e) {
            const t = S[e],
              n = t.start;
            for (let e = n, r = n + t.count; e < r; e += 3) A(i[e + 0]), A(i[e + 1]), A(i[e + 2]);
          }
        }
        computeVertexNormals() {
          ...
          if (void 0 !== t) {
            ...
            const r = new n.P(),
              ...
              d = new n.P();
            if (e)
              for (let n = 0, o = e.count; n < o; n += 3) {
                const o = e.getX(n + 0),
                  p = e.getX(n + 1),
                  f = e.getX(n + 2);
                r.fromBufferAttribute(t, o),
                  ...
                  c.add(u),
                  h.add(u),
                  i.setXYZ(o, l.x, l.y, l.z),
                  i.setXYZ(p, c.x, c.y, c.z),
                  i.setXYZ(f, h.x, h.y, h.z);
              }
            else
              for (let e = 0, n = t.count; e < n; e += 3)
                r.fromBufferAttribute(t, e + 0),
                  ...
                  d.subVectors(r, a),
                  u.cross(d),
                  i.setXYZ(e + 0, u.x, u.y, u.z),
                  i.setXYZ(e + 1, u.x, u.y, u.z),
                  i.setXYZ(e + 2, u.x, u.y, u.z);
        ...
        normalizeNormals() {
          ...
          for (let t = 0, i = e.count; t < i; t++)
            M.fromBufferAttribute(e, t), M.normalize(), e.setXYZ(t, M.x, M.y, M.z);
        }
        toNonIndexed() {
          function e(e, t) {
            const i = e.array,
            ...
            for (let r = 0, o = t.length; r < o; r++) {
              ...
              for (let e = 0; e < n; e++) a[l++] = i[s++];
            }
            return new o.Tl(a, n, r);
          }
    ...
    3740: (e, t, i) => {
      ...
      class w extends s.p {
        ...
        lookAt(e, t, i) {
          ...
          this.updateWorldMatrix(!0, !1),
            ...
            this.isCamera || this.isLight ? f.lookAt(g, m, this.up) : f.lookAt(m, g, this.up),
            this.quaternion.setFromRotationMatrix(f),
            n &&
              (f.extractRotation(n.matrixWorld), p.setFromRotationMatrix(f), this.quaternion.premultiply(p.invert()));
        }
        add(e) {
        ...
        remove(e) {
          ...
          return -1 !== t && ((e.parent = null), this.children.splice(t, 1), e.dispatchEvent(b)), this;
        }
        removeFromParent() {
          const e = this.parent;
        ...
        attach(e) {
          return (
            ...
            null !== e.parent && (e.parent.updateWorldMatrix(!0, !1), f.multiply(e.parent.matrixWorld)),
            e.applyMatrix4(f),
            this.add(e),
        ...
        updateWorldMatrix(e, t) {
          const i = this.parent;
          if (
            (!0 === e && null !== i && !0 === i.matrixWorldAutoUpdate && i.updateWorldMatrix(!0, !1),
            this.matrixAutoUpdate && this.updateMatrix(),
            null === this.parent
              ? this.matrixWorld.copy(this.matrix)
              : this.matrixWorld.multiplyMatrices(this.parent.matrixWorld, this.matrix),
      ...
      (w.DefaultUp = new r.P(0, 1, 0)), (w.DefaultMatrixAutoUpdate = !0), (w.DefaultMatrixWorldAutoUpdate = !0);
    },
    4804: (e, t, i) => {
      i.d(t, { i: () => a });
      var n = i(8384),
      ...
      class a {
        ...
        intersectObjects(e) {
          ...
          for (let n = 0, r = e.length; n < r; n++) o(e[n], this, i, t);
          return i.sort(s), i;
        }
      }
      function s(e, t) {
      ...
      function o(e, t, i, n) {
        if ((e.layers.test(t.layers) && e.raycast(t, i), !0 === n)) {
          const n = e.children;
          for (let e = 0, r = n.length; e < r; e++) o(n[e], t, i, !0);
        }
      }
    },
    4222: (e, t, i) => {
          ...
          if (e.data) {
            ...
            for (let e = 0; e < t.length; e++)
              t instanceof Uint8Array || t instanceof Uint8ClampedArray
                ? (t[e] = Math.floor(255 * (0, r.PB)(t[e] / 255)))
                : (t[e] = (0, r.PB)(t[e]));
      ...
      class l extends s {
        ...
        load(e, t, i, r) {
          ...
          return (
            ...
            'data:' !== e.slice(0, 5) && void 0 !== this.crossOrigin && (l.crossOrigin = this.crossOrigin),
            a.manager.itemStart(e),
            (l.src = e),
            l
          );
      ...
      class a extends n.F {
        ...
        copy(e) {
          return (
            ...
            (this.uniforms = (0, r.dw)(e.uniforms)),
            (this.uniformsGroups = (0, r.fd)(e.uniformsGroups)),
    ...
    578: (e, t, i) => {
      ...
      class r {
        constructor() {
          let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : new n.P(1 / 0, 1 / 0, 1 / 0),
            t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : new n.P(-1 / 0, -1 / 0, -1 / 0);
        ...
        setFromCenterAndSize(e, t) {
          const i = s.copy(t).multiplyScalar(0.5);
          ...
          if (void 0 !== i)
            if (t && null != i.attributes && void 0 !== i.attributes.position) {
              ...
              for (let i = 0, n = t.count; i < n; i++)
                s.fromBufferAttribute(t, i).applyMatrix4(e.matrixWorld), this.expandByPoint(s);
            } else
        ...
        intersectsTriangle(e) {
          ...
          return (
            !!v(t, l, c, h, m) &&
            ((t = [1, 0, 0, 0, 1, 0, 0, 0, 1]),
            !!v(t, l, c, h, m) && (g.crossVectors(u, d), (t = [g.x, g.y, g.z]), v(t, l, c, h, m)))
          );
        }
        clampPoint(e, t) {
        ...
        getBoundingSphere(e) {
          return this.getCenter(e.center), (e.radius = 0.5 * this.getSize(s).length()), e;
        }
        intersect(e) {
        ...
        applyMatrix4(e) {
          return (
            this.isEmpty() ||
              (a[0].set(this.min.x, this.min.y, this.min.z).applyMatrix4(e),
              a[1].set(this.min.x, this.min.y, this.max.z).applyMatrix4(e),
              a[2].set(this.min.x, this.max.y, this.min.z).applyMatrix4(e),
              a[3].set(this.min.x, this.max.y, this.max.z).applyMatrix4(e),
              a[4].set(this.max.x, this.min.y, this.min.z).applyMatrix4(e),
              a[5].set(this.max.x, this.min.y, this.max.z).applyMatrix4(e),
              a[6].set(this.max.x, this.max.y, this.min.z).applyMatrix4(e),
              a[7].set(this.max.x, this.max.y, this.max.z).applyMatrix4(e),
      ...
      const a = [new n.P(), new n.P(), new n.P(), new n.P(), new n.P(), new n.P(), new n.P(), new n.P()],
        s = new n.P(),
        o = new r(),
        l = new n.P(),
        c = new n.P(),
      ...
      class d {
        ...
        setHex(e) {
          ...
          return (
            ...
            (this.g = ((e >> 8) & 255) / 255),
            (this.b = (255 & e) / 255),
            r.ep.toWorkingColorSpace(this, t),
            this
          );
        }
        setRGB(e, t, i) {
        ...
        setHSL(e, t, i) {
          ...
          if (((e = (0, n.kz)(e, 1)), (t = (0, n.uZ)(t, 0, 1)), (i = (0, n.uZ)(i, 0, 1)), 0 === t))
        ...
        setStyle(e) {
          let t,
            i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : a.KI;
          function n(e) {
          ...
          if ((t = /^((?:rgb|hsl)a?)\(([^\)]*)\)/.exec(e))) {
            ...
            switch (a) {
              ...
              case 'rgba':
                if ((e = /^\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*(?:,\s*(\d*\.?\d+)\s*)?$/.exec(s)))
                  return (
                    ...
                    r.ep.toWorkingColorSpace(this, i),
                    n(e[4]),
                    this
                  );
                if ((e = /^\s*(\d+)\%\s*,\s*(\d+)\%\s*,\s*(\d+)\%\s*(?:,\s*(\d*\.?\d+)\s*)?$/.exec(s)))
              ...
              case 'hsla':
                if (
                  (e = /^\s*(\d*\.?\d+)\s*,\s*(\d*\.?\d+)\%\s*,\s*(\d*\.?\d+)\%\s*(?:,\s*(\d*\.?\d+)\s*)?$/.exec(s))
                ) {
        ...
        getHex() {
          ...
          return (
            r.ep.fromWorkingColorSpace(u(this, o), e),
            ((0, n.uZ)(255 * o.r, 0, 255) << 16) ^
              ((0, n.uZ)(255 * o.g, 0, 255) << 8) ^
              ((0, n.uZ)(255 * o.b, 0, 255) << 0)
          );
        }
        getHexString() {
          let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : a.KI;
        ...
        getHSL(e) {
          ...
          if (c === l) (h = 0), (d = 0);
            ...
            const e = l - c;
            switch (((d = p <= 0.5 ? e / (l + c) : e / (2 - l - c)), l)) {
              case i:
                h = (n - s) / e + (n < s ? 6 : 0);
                break;
              case n:
        ...
        getStyle() {
          ...
          return (
            ...
            e !== a.KI
              ? `color(${e} ${o.r} ${o.g} ${o.b})`
              : `rgb(${(255 * o.r) | 0},${(255 * o.g) | 0},${(255 * o.b) | 0})`
          );
        }
        offsetHSL(e, t, i) {
    ...
    8286: (e, t, i) => {
      ...
      const s = { [n.KI]: { [n.GU]: r }, [n.GU]: { [n.KI]: a } },
        o = {
          legacyMode: !0,
    ...
    9800: (e, t, i) => {
      ...
      class l {
        constructor() {
          let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
            ...
            n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : l.DefaultOrder;
      ...
      (l.DefaultOrder = 'XYZ'), (l.RotationOrders = ['XYZ', 'YZX', 'ZXY', 'XZY', 'YXZ', 'ZYX']);
    },
    6563: (e, t, i) => {
      i.d(t, {
        DO: () => s,
    ...
    4914: (e, t, i) => {
      ...
      class n {
        ...
        extractBasis(e, t, i) {
          return (
            e.setFromMatrix3Column(this, 0), t.setFromMatrix3Column(this, 1), i.setFromMatrix3Column(this, 2), this
          );
        }
        setFromMatrix4(e) {
          const t = e.elements;
        ...
        setUvTransform(e, t, i, n, r, a, s) {
          const o = Math.cos(r),
            l = Math.sin(r);
          return (
            this.set(i * o, i * l, -i * (o * a + l * s) + a + e, -n * l, n * o, -n * (-l * a + o * s) + s + t, 0, 0, 1),
            this
          );
        }
        scale(e, t) {
    ...
    9049: (e, t, i) => {
      ...
      class r {
        ...
        extractRotation(e) {
          const t = this.elements,
            i = e.elements,
            n = 1 / a.setFromMatrixColumn(e, 0).length(),
            r = 1 / a.setFromMatrixColumn(e, 1).length(),
            s = 1 / a.setFromMatrixColumn(e, 2).length();
          return (
            (t[0] = i[0] * n),
            (t[1] = i[1] * n),
            (t[2] = i[2] * n),
        ...
        lookAt(e, t, i) {
          ...
          return (
            ...
            c.crossVectors(i, u),
            0 === c.lengthSq() &&
              (1 === Math.abs(i.z) ? (u.x += 1e-4) : (u.z += 1e-4), u.normalize(), c.crossVectors(i, u)),
            c.normalize(),
            h.crossVectors(u, c),
            (n[0] = c.x),
            (n[4] = h.x),
        ...
        multiplyMatrices(e, t) {
          ...
          return (
            ...
            (r[4] = a * S + s * E + o * P + l * N),
            (r[8] = a * b + s * A + o * D + l * O),
            (r[12] = a * w + s * C + o * R + l * z),
            (r[1] = c * y + h * T + u * L + d * I),
            (r[5] = c * S + h * E + u * P + d * N),
            (r[9] = c * b + h * A + u * D + d * O),
            (r[13] = c * w + h * C + u * R + d * z),
            (r[2] = p * y + f * T + m * L + g * I),
            (r[6] = p * S + f * E + m * P + g * N),
            (r[10] = p * b + f * A + m * D + g * O),
            (r[14] = p * w + f * C + m * R + g * z),
            (r[3] = _ * y + v * T + x * L + M * I),
            (r[7] = _ * S + v * E + x * P + M * N),
            (r[11] = _ * b + v * A + x * D + M * O),
            (r[15] = _ * w + v * C + x * R + M * z),
            this
          );
        }
        multiplyScalar(e) {
        ...
        determinant() {
          ...
          return (
            ...
            e[7] * (+t * o * d - t * l * u + r * a * u - n * a * d + n * l * c - r * o * c) +
            e[11] * (+t * l * h - t * s * d - r * a * h + i * a * d + r * s * c - i * l * c) +
            e[15] * (-n * s * c - t * o * h + t * s * u + n * a * h - i * a * u + i * o * c)
          );
        }
        transpose() {
          const e = this.elements;
        ...
        invert() {
          ...
          return (
            (e[0] = _ * S),
            (e[1] = (f * u * r - h * m * r - f * n * d + i * m * d + h * n * g - i * u * g) * S),
            (e[2] = (s * m * r - f * o * r + f * n * l - i * m * l - s * n * g + i * o * g) * S),
            (e[3] = (h * o * r - s * u * r - h * n * l + i * u * l + s * n * d - i * o * d) * S),
            (e[4] = v * S),
            (e[5] = (c * m * r - p * u * r + p * n * d - t * m * d - c * n * g + t * u * g) * S),
            (e[6] = (p * o * r - a * m * r - p * n * l + t * m * l + a * n * g - t * o * g) * S),
            (e[7] = (a * u * r - c * o * r + c * n * l - t * u * l - a * n * d + t * o * d) * S),
            (e[8] = x * S),
            (e[9] = (p * h * r - c * f * r - p * i * d + t * f * d + c * i * g - t * h * g) * S),
            (e[10] = (a * f * r - p * s * r + p * i * l - t * f * l - a * i * g + t * s * g) * S),
            (e[11] = (c * s * r - a * h * r - c * i * l + t * h * l + a * i * d - t * s * d) * S),
            (e[12] = M * S),
            (e[13] = (c * f * n - p * h * n + p * i * u - t * f * u - c * i * m + t * h * m) * S),
            (e[14] = (p * s * n - a * f * n - p * i * o + t * f * o + a * i * m - t * s * m) * S),
            (e[15] = (a * h * n - c * s * n + c * i * o - t * h * o - a * i * u + t * s * u) * S),
            this
          );
        }
        scale(e) {
        ...
        decompose(e, t, i) {
          ...
          const o = a.set(n[4], n[5], n[6]).length(),
    ...
    8384: (e, t, i) => {
      ...
      class u {
        constructor() {
          let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : new n.P(),
            t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : new n.P(0, 0, -1);
        ...
        distanceSqToPoint(e) {
          ...
          return t < 0
            ...
            : (r.copy(this.direction).multiplyScalar(t).add(this.origin), r.distanceToSquared(e));
        }
        distanceSqToSegment(e, t, i, n) {
          a.copy(e).add(t).multiplyScalar(0.5), s.copy(t).sub(e).normalize(), o.copy(this.origin).sub(a);
          ...
          let p, f, m, g;
          if (d > 0)
            if (((p = l * h - c), (f = l * c - h), (g = r * d), p >= 0))
              if (f >= -g)
                if (f <= g) {
                  const e = 1 / d;
                  (p *= e), (f *= e), (m = p * (p + l * f + 2 * c) + f * (l * p + f + 2 * h) + u);
                } else (f = r), (p = Math.max(0, -(l * f + c))), (m = -p * p + f * (f + 2 * h) + u);
              else (f = -r), (p = Math.max(0, -(l * f + c))), (m = -p * p + f * (f + 2 * h) + u);
            else
              f <= -g
                ? ((p = Math.max(0, -(-l * r + c))),
                  (f = p > 0 ? -r : Math.min(Math.max(-r, -h), r)),
                  (m = -p * p + f * (f + 2 * h) + u))
                : f <= g
                ? ((p = 0), (f = Math.min(Math.max(-r, -h), r)), (m = f * (f + 2 * h) + u))
                : ((p = Math.max(0, -(l * r + c))),
                  (f = p > 0 ? r : Math.min(Math.max(-r, -h), r)),
                  (m = -p * p + f * (f + 2 * h) + u));
          else (f = l > 0 ? -r : r), (p = Math.max(0, -(l * f + c))), (m = -p * p + f * (f + 2 * h) + u);
          return (
            i && i.copy(this.direction).multiplyScalar(p).add(this.origin), n && n.copy(s).multiplyScalar(f).add(a), m
          );
        }
        intersectSphere(e, t) {
        ...
        intersectTriangle(e, t, i, n, r) {
          ...
          const u = a * this.direction.dot(c.crossVectors(o, c));
          if (u < 0) return null;
    ...
    5604: (e, t, i) => {
      ...
      class c {
        constructor() {
          let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : new r.P(),
            t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : -1;
        ...
        union(e) {
          return (
            !0 === this.center.equals(e.center)
              ? o.set(0, 0, 1).multiplyScalar(e.radius)
              : o.subVectors(e.center, this.center).normalize().multiplyScalar(e.radius),
            this.expandByPoint(s.copy(e.center).add(o)),
            this.expandByPoint(s.copy(e.center).sub(o)),
            this
          );
        }
        equals(e) {
            ...
            return (
              e > o && e > _
                ? e < a
                  ...
                  : ((i = Math.sqrt(e)), (n = v / i), (r = x / i))
                : o > _
                ? o < a
                  ? ((i = 0.707106781), (n = 0), (r = 0.707106781))
                  : ((n = Math.sqrt(o)), (i = v / n), (r = M / n))
                : _ < a
                ? ((i = 0.707106781), (n = 0.707106781), (r = 0))
                : ((r = Math.sqrt(_)), (i = x / r), (n = M / r)),
              this.set(i, n, r, t),
              this
            );
          }
    ...
    394: (e, t, i) => {
      ...
      class x {
        constructor() {
          let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : new n.P(),
            t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : new n.P(),
            i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : new n.P();
        ...
        getArea() {
          return c.subVectors(this.c, this.b), h.subVectors(this.a, this.b), 0.5 * c.cross(h).length();
        }
        getMidpoint(e) {
          return e
        ...
        closestPointToPoint(e, t) {
          ...
          const y = c * x - d * h;
          if (y <= 0 && h - c >= 0 && d - x >= 0)
            return m.subVectors(r, n), (s = (h - c) / (h - c + (d - x))), t.copy(n).addScaledVector(m, s);
          const S = 1 / (y + M + u);
      ...
      class V extends l.T {
        constructor() {
          let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : new S.u(),
            t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : new y.v();
          super(),
            (this.isMesh = !0),
            (this.type = 'Mesh'),
            (this.geometry = e),
        ...
        raycast(e, t) {
          ...
          if (
            ...
            T.applyMatrix4(r),
            !1 === e.ray.intersectsSphere(T))
          )
            return;
          if (
            (b.copy(r).invert(),
            w.copy(e.ray).applyMatrix4(b),
            null !== i.boundingBox && !1 === w.intersectsBox(i.boundingBox))
          )
            return;
          let a;
          const s = i.index,
          ...
          if (null !== s)
              ...
              for (let i = 0, r = d.length; i < r; i++) {
                ...
                for (
                  let i = Math.max(r.start, p.start),
                    n = Math.min(s.count, Math.min(r.start + r.count, p.start + p.count));
                  i < n;
                  i += 3
                ) {
                  const n = s.getX(i),
                    d = s.getX(i + 1),
                    p = s.getX(i + 2);
                  (a = k(this, f, e, w, o, l, c, h, u, n, d, p)),
            ...
            if (Array.isArray(n))
              for (let i = 0, r = d.length; i < r; i++) {
                ...
                for (
                  let i = Math.max(r.start, p.start),
                    n = Math.min(o.count, Math.min(r.start + r.count, p.start + p.count));
                  i < n;
                  i += 3
                ) {
                  (a = k(this, s, e, w, o, l, c, h, u, i, i + 1, i + 2)),
                    a && ((a.faceIndex = Math.floor(i / 3)), (a.face.materialIndex = r.materialIndex), t.push(a));
                }
              }
            else {
              for (let i = Math.max(0, p.start), r = Math.min(o.count, p.start + p.count); i < r; i += 3) {
                (a = k(this, n, e, w, o, l, c, h, u, i, i + 1, i + 2)),
                  a && ((a.faceIndex = Math.floor(i / 3)), t.push(a));
              }
            }
        }
      }
      function k(e, t, i, a, s, o, l, c, h, u, d, p) {
        ...
        if (o && f) {
          ...
          for (let e = 0, t = o.length; e < t; e++) {
            const t = f[e],
              i = o[e];
            0 !== t &&
              (L.fromBufferAttribute(i, u),
              P.fromBufferAttribute(i, d),
              D.fromBufferAttribute(i, p),
              l
                ? (R.addScaledVector(L, t), I.addScaledVector(P, t), N.addScaledVector(D, t))
                : (R.addScaledVector(L.sub(E), t), I.addScaledVector(P.sub(A), t), N.addScaledVector(D.sub(C), t)));
          }
          E.add(R), A.add(I), C.add(N);
        }
        e.isSkinnedMesh && (e.boneTransform(u, E), e.boneTransform(d, A), e.boneTransform(p, C));
        const m = (function (e, t, i, n, r, a, s, o) {
          let l;
          if (
            ((l =
              t.side === M._L ? n.intersectTriangle(s, a, r, !0, o) : n.intersectTriangle(r, a, s, t.side !== M.eh, o)),
            null === l)
          )
            return null;
          B.copy(o), B.applyMatrix4(e.matrixWorld);
          const c = i.ray.origin.distanceTo(B);
          return c < i.near || c > i.far ? null : { distance: c, point: B.clone(), object: e };
        })(e, t, i, a, E, A, C, F);
        if (m) {
          c &&
            ...
            (m.uv = x.getUV(F, E, A, C, O, z, U, new r.F()))),
            h &&
              (O.fromBufferAttribute(h, u),
              z.fromBufferAttribute(h, d),
              U.fromBufferAttribute(h, p),
              (m.uv2 = x.getUV(F, E, A, C, O, z, U, new r.F())));
          const e = { a: u, b: d, c: p, normal: new n.P(), materialIndex: 0 };
          x.getNormal(E, A, C, e.normal), (m.face = e);
        }
        return m;
      }
    },
      ...
      class l extends n.p {
        constructor(e, t) {
          ...
          super(),
            ...
            (this.height = t),
            (this.depth = 1),
            (this.scissor = new s.L(0, 0, e, t)),
            (this.scissorTest = !1),
            (this.viewport = new s.L(0, 0, e, t));
          const n = { width: e, height: t, depth: 1 };
          (this.texture = new r.x(
            n,
            i.mapping,
            i.wrapS,
            i.wrapT,
    ...
    345: (e, t, i) => {
      ...
      class u {
        constructor() {
          let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : new a.P(1, 0, 0),
            t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0;
        ...
        applyMatrix4(e, t) {
          const i = t || h.getNormalMatrix(e),
            n = this.coplanarPoint(l).applyMatrix4(e),
      ...
      class f {
        constructor() {
          let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : new u(),
            t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : new u(),
            i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : new u(),
            n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : new u(),
            r = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : new u(),
            a = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : new u();
        ...
        setFromProjectionMatrix(e) {
          const t = this.planes,
            ...
            v = i[15];
          return (
            t[0].setComponents(s - n, h - o, f - u, v - m).normalize(),
            t[1].setComponents(s + n, h + o, f + u, v + m).normalize(),
            t[2].setComponents(s + r, h + l, f + d, v + g).normalize(),
            t[3].setComponents(s - r, h - l, f - d, v - g).normalize(),
            t[4].setComponents(s - a, h - c, f - p, v - _).normalize(),
            t[5].setComponents(s + a, h + c, f + p, v + _).normalize(),
            this
          );
        }
        intersectsObject(e) {
        ...
        intersectsBox(e) {
          ...
          for (let i = 0; i < 6; i++) {
            const n = t[i];
            if (
              ((p.x = n.normal.x > 0 ? e.max.x : e.min.x),
              (p.y = n.normal.y > 0 ? e.max.y : e.min.y),
              (p.z = n.normal.z > 0 ? e.max.z : e.min.z),
              n.distanceToPoint(p) < 0)
            )
              return !1;
          }
          return !0;
              ...
              ? n.set(
                  ...
                  (function (t, n) {
                    const r = t.array,
                      ...
                      s = e.createBuffer();
                    let o;
                    if ((e.bindBuffer(n, s), e.bufferData(n, r, a), t.onUploadCallback(), r instanceof Float32Array))
                      o = 5126;
                    ...
                    return { buffer: s, type: o, bytesPerElement: r.BYTES_PER_ELEMENT, version: t.version };
                  })(t, r)
                )
              : a.version < t.version &&
                (!(function (t, n, r) {
      ...
      class S extends M.u {
        constructor() {
          ...
          let d = 0,
            p = 0;
          function f(e, t, i, n, r, s, f, m, g, _, v) {
            const x = s / g,
              M = f / _,
              y = s / 2,
              S = f / 2,
            ...
            o.addGroup(p, A, v), (p += A), (d += E);
          }
          f('z', 'y', 'x', -1, -1, i, t, e, s, r, 0),
            f('z', 'y', 'x', 1, -1, i, t, -e, s, r, 1),
            f('x', 'z', 'y', 1, 1, e, i, t, n, s, 2),
            f('x', 'z', 'y', 1, -1, e, i, -t, n, s, 3),
            f('x', 'y', 'z', 1, -1, e, t, i, n, r, 4),
            f('x', 'y', 'z', -1, -1, e, t, -i, n, r, 5),
            this.setIndex(l),
            this.setAttribute('position', new y.a$(c, 3)),
            this.setAttribute('normal', new y.a$(h, 3)),
            this.setAttribute('uv', new y.a$(u, 2));
        }
        static fromJSON(e) {
      ...
      const L = {
          common: {
            diffuse: { value: new T.I(16777215) },
            opacity: { value: 1 },
            map: { value: null },
          ...
          normalmap: { normalMap: { value: null }, normalScale: { value: new g.F(1, 1) } },
          displacementmap: {
          ...
          fog: {
            ...
            fogNear: { value: 1 },
            fogFar: { value: 2e3 },
            fogColor: { value: new T.I(16777215) },
          },
          lights: {
        ...
        P = {
          basic: {
            uniforms: (0, C.Rh)([L.common, L.specularmap, L.envmap, L.aomap, L.lightmap, L.fog]),
          ...
          phong: {
            uniforms: (0, C.Rh)([
              ...
              L.fog,
              L.lights,
              { emissive: { value: new T.I(0) }, specular: { value: new T.I(1118481) }, shininess: { value: 30 } },
            ]),
          ...
          points: {
            uniforms: (0, C.Rh)([L.points, L.fog]),
          ...
          normal: {
            uniforms: (0, C.Rh)([L.common, L.bumpmap, L.normalmap, L.displacementmap, { opacity: { value: 1 } }]),
            vertexShader: A.meshnormal_vert,
            fragmentShader: A.meshnormal_frag,
          },
          sprite: {
            uniforms: (0, C.Rh)([L.sprite, L.fog]),
            vertexShader: A.sprite_vert,
            fragmentShader: A.sprite_frag,
          },
          background: {
            uniforms: { uvTransform: { value: new o.V() }, t2D: { value: null } },
            vertexShader: A.background_vert,
            fragmentShader: A.background_frag,
          },
          cube: {
            uniforms: (0, C.Rh)([L.envmap, { opacity: { value: 1 } }]),
          ...
          distanceRGBA: {
            uniforms: (0, C.Rh)([
              L.common,
              L.displacementmap,
              { referencePosition: { value: new a.P() }, nearDistance: { value: 1 }, farDistance: { value: 1e3 } },
            ]),
            vertexShader: A.distanceRGBA_vert,
            fragmentShader: A.distanceRGBA_frag,
          },
          shadow: {
            uniforms: (0, C.Rh)([L.lights, L.fog, { color: { value: new T.I(0) }, opacity: { value: 1 } }]),
            vertexShader: A.shadow_vert,
            fragmentShader: A.shadow_frag,
          },
        };
      function D(e, t, i, r, a, s) {
        const o = new T.I(0);
        let l,
          c,
          h = !0 === a ? 0 : 1,
        ...
        return {
          ...
          render: function (i, a) {
            ...
            _ && 'additive' === _.environmentBlendMode && (m = null),
              null === m ? f(o, h) : m && m.isColor && (f(m, 1), (s = !0)),
              (e.autoClear || s) && e.clear(e.autoClearColor, e.autoClearDepth, e.autoClearStencil),
              m && (m.isCubeTexture || m.mapping === n.g8)
                ? (void 0 === c &&
                    ((c = new E.K(
                      new S(1, 1, 1),
                      new w.j({
                        name: 'BackgroundCubeMaterial',
                        uniforms: (0, C.dw)(P.cube.uniforms),
                        vertexShader: P.cube.vertexShader,
                        fragmentShader: P.cube.fragmentShader,
                        side: n._L,
                        depthTest: !1,
                        depthWrite: !1,
                        fog: !1,
                  ...
                  (u === m && d === m.version && p === e.toneMapping) ||
                    ((c.material.needsUpdate = !0), (u = m), (d = m.version), (p = e.toneMapping)),
                  c.layers.enableAll(),
                ...
                : m &&
                  ...
                  (void 0 === l &&
                    ((l = new E.K(
                      ...
                      new w.j({
                        ...
                        uniforms: (0, C.dw)(P.background.uniforms),
                        vertexShader: P.background.vertexShader,
                        fragmentShader: P.background.fragmentShader,
                        side: n.Wl,
                        depthTest: !1,
                        depthWrite: !1,
                        fog: !1,
                  ...
                  (u === m && d === m.version && p === e.toneMapping) ||
                    ((l.material.needsUpdate = !0), (u = m), (d = m.version), (p = e.toneMapping)),
                  l.layers.enableAll(),
      ...
      function R(e, t, i, n) {
        ...
        function v(t, i, r, a, s, o) {
          !0 !== n.isWebGL2 || (5124 !== r && 5125 !== r)
            ? e.vertexAttribPointer(t, i, r, a, s, o)
            : e.vertexAttribIPointer(t, i, r, s, o);
        }
        function x() {
          ...
          setup: function (r, l, d, x, M) {
            ...
            if (s) {
              ...
              (c.geometry === x.id && c.program === d.id && c.wireframe === e) ||
                ((c.geometry = x.id), (c.program = d.id), (c.wireframe = e), (y = !0));
            }
            null !== M && i.update(M, 34963),
              (y || h) &&
                ((h = !1),
                (function (r, a, s, o) {
                  if (
                  ...
                  for (const t in c) {
                    ...
                    if (n.location >= 0) {
                      ...
                      if (
                        (void 0 === a &&
                          ('instanceMatrix' === t && r.instanceMatrix && (a = r.instanceMatrix),
                        ...
                        if (a.isInterleavedBufferAttribute) {
                          ...
                          for (let e = 0; e < n.locationSize; e++)
                            v(n.location + e, s / n.locationSize, h, t, l * u, (d + (s / n.locationSize) * e) * u);
                        } else {
                          ...
                          e.bindBuffer(34962, c);
                          for (let e = 0; e < n.locationSize; e++)
                            v(n.location + e, s / n.locationSize, h, t, s * u, (s / n.locationSize) * e * u);
                        }
                      } else if (void 0 !== h) {
                        const i = h[t];
                        if (void 0 !== i)
                ...
                null !== M && e.bindBuffer(34963, i.get(M).buffer));
          },
          reset: x,
          resetDefaultState: M,
          dispose: function () {
          ...
          if (0 !== a) {
            if (((o = c.value), !0 !== r || null === o)) {
              ...
              for (let t = 0, i = n; t !== a; ++t, i += 4)
                s.copy(e[t]).applyMatrix4(r, l), s.normal.toArray(o, i), (o[i + 3] = s.constant);
            }
            (c.value = o), (c.needsUpdate = !0);
          }
          return (t.numPlanes = a), (t.numIntersection = 0), o;
        }
        (this.uniform = c),
          (this.numPlanes = 0),
      ...
      P.physical = {
        uniforms: (0, C.Rh)([
          P.standard.uniforms,
          {
            ...
            attenuationColor: { value: new T.I(0) },
            specularIntensity: { value: 1 },
            specularIntensityMap: { value: null },
            specularColor: { value: new T.I(1, 1, 1) },
      ...
      class G extends k.x {
        constructor(e, t, i, r, a, s, o, l, c, h) {
          super((e = void 0 !== e ? e : []), (t = void 0 !== t ? t : n.fY), i, r, a, s, o, l, c, h),
      ...
      class H extends z.d {
        ...
        fromEquirectangularTexture(e, t) {
          ...
          return new V(1, 10, this).update(e, s), (t.minFilter = o), s.geometry.dispose(), s.material.dispose(), this;
        }
        clear(e, t, i, n) {
      ...
      class j extends q.V {
        constructor() {
          let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : -1,
            ...
            i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 1,
            n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : -1,
            r = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 0.1,
      ...
      var X = i(697);
      const Y = [0.125, 0.215, 0.35, 0.446, 0.526, 0.582],
        Z = 20,
        K = new j(),
        J = new T.I();
      let Q = null;
      ...
      class ie {
        ...
        compileCubemapShader() {
          null === this._cubemapMaterial &&
            ((this._cubemapMaterial = se()), this._compileMaterial(this._cubemapMaterial));
        }
        compileEquirectangularShader() {
          null === this._equirectMaterial &&
            ((this._equirectMaterial = ae()), this._compileMaterial(this._equirectMaterial));
        }
        dispose() {
          this._dispose(),
          ...
          if (null === this._pingPongRenderTarget || this._pingPongRenderTarget.width !== e) {
            ...
            ({
              ...
              for (let s = 0; s < a; s++) {
                ...
                const S = new M.u();
                S.setAttribute('position', new y.Tl(_, f)),
                  S.setAttribute('uv', new y.Tl(v, m)),
                  S.setAttribute('faceIndex', new y.Tl(x, g)),
                  t.push(S),
                  r > 4 && r--;
              }
              ...
              (this._blurMaterial = (function (e, t, i) {
                const r = new Float32Array(Z),
                  s = new a.P(0, 1, 0);
                return new w.j({
                  name: 'SphericalGaussianBlur',
                  defines: { n: Z, CUBEUV_TEXEL_WIDTH: 1 / t, CUBEUV_TEXEL_HEIGHT: 1 / i, CUBEUV_MAX_MIP: `${e}.0` },
                  uniforms: {
                    envMap: { value: null },
                    samples: { value: 1 },
                    weights: { value: r },
        ...
        _sceneToCubeUV(e, t, i, r) {
          ...
          const u = new X.v({ name: 'PMREM.Background', side: n._L, depthWrite: !1, depthTest: !1 }),
            d = new E.K(new S(), u);
          let p = !1;
          const f = e.background;
          f ? f.isColor && (u.color.copy(f), (e.background = null), (p = !0)) : (u.color.copy(J), (p = !0));
          for (let t = 0; t < 6; t++) {
            const i = t % 3;
            0 === i
              ? (a.up.set(0, s[t], 0), a.lookAt(o[t], 0, 0))
              : 1 === i
              ? (a.up.set(0, 0, s[t]), a.lookAt(0, o[t], 0))
              : (a.up.set(0, s[t], 0), a.lookAt(0, 0, o[t]));
        ...
        _textureToCubeUV(e, t) {
          const i = this._renderer,
            r = e.mapping === n.fY || e.mapping === n.vx;
          r
            ? (null === this._cubemapMaterial && (this._cubemapMaterial = se()),
              (this._cubemapMaterial.uniforms.flipEnvMap.value = !1 === e.isRenderTargetTexture ? -1 : 1))
            : null === this._equirectMaterial && (this._equirectMaterial = ae());
          const a = r ? this._cubemapMaterial : this._equirectMaterial,
            s = new E.K(this._lodPlanes[0], a);
        ...
        _halfBlur(e, t, i, n, r, a, s) {
          const o = this._renderer,
            ...
            c = new E.K(this._lodPlanes[n], l),
            h = l.uniforms,
            u = this._sizeLods[i] - 1,
            d = isFinite(r) ? Math.PI / (2 * u) : (2 * Math.PI) / 39,
            p = r / d,
            f = isFinite(r) ? 1 + Math.floor(3 * p) : Z,
            m = [];
          let g = 0;
          for (let e = 0; e < Z; ++e) {
            const t = e / p,
          ...
          (h.dTheta.value = d), (h.mipInt.value = _ - i);
          const v = this._sizeLods[n];
          re(t, 3 * v * (n > _ - 4 ? n - _ + 4 : 0), 4 * (this._cubeSize - v), 3 * v, 2 * v),
            o.setRenderTarget(t),
            o.render(c, K);
        }
      }
            ...
            if (a && a.isTexture) {
              ...
              if (o || l) {
                if (a.isRenderTargetTexture && !0 === a.needsPMREMUpdate) {
                  ...
                  return (
                    null === i && (i = new ie(e)),
                    (n = o ? i.fromEquirectangular(a, n) : i.fromCubemap(a, n)),
                    t.set(a, n),
                    n.texture
                  );
                }
      ...
      function ue(e, t, i, n) {
        ...
        function o(e) {
          ...
          const o = new ((0, he.H7)(i) ? y.lC : y.ql)(i, 1);
          o.version = s;
          const l = a.get(e);
          ...
          update: function (c, h, u, d) {
            ...
            if (!0 === t.isWebGL2) {
              ...
              if (void 0 === _ || _.count !== m) {
                ...
                const M = void 0 !== h.morphAttributes.position,
                  y = void 0 !== h.morphAttributes.normal,
                  S = void 0 !== h.morphAttributes.color,
                  b = h.morphAttributes.position || [],
                  w = h.morphAttributes.normal || [],
                  T = h.morphAttributes.color || [];
                let E = 0;
                !0 === M && (E = 1), !0 === y && (E = 2), !0 === S && (E = 3);
                let A = h.attributes.position.count * E,
                  C = 1;
                A > t.maxTextureSize && ((C = Math.ceil(A / t.maxTextureSize)), (A = t.maxTextureSize));
                const L = new Float32Array(A * C * 4 * m),
                  P = new fe(L, A, C, m);
                  ...
                  for (let F = 0; F < N.count; F++) {
                    ...
                    !0 === M &&
                      ...
                      !0 === y &&
                        ...
                        (L[U + B + 7] = 0)),
                      !0 === S &&
                        (o.fromBufferAttribute(z, F),
                        (L[U + B + 8] = o.x),
                        (L[U + B + 9] = o.y),
                        (L[U + B + 10] = o.z),
                        (L[U + B + 11] = 4 === z.itemSize ? o.w : 1));
                  }
                }
                function R() {
                  P.dispose(), s.delete(h), h.removeEventListener('dispose', R);
                }
                (_ = { count: m, texture: P, size: new g.F(A, C) }), s.set(h, _), h.addEventListener('dispose', R);
              }
              let v = 0;
              for (let V = 0; V < p.length; V++) v += p[V];
              ...
              d.getUniforms().setValue(e, 'morphTargetBaseInfluence', x),
                ...
                d.getUniforms().setValue(e, 'morphTargetsTexture', _.texture, i),
              ...
              for (let K = 0; K < 8; K++)
                K < k && G[K][1]
                  ? ((l[K][0] = G[K][0]), (l[K][1] = G[K][1]))
                  : ((l[K][0] = Number.MAX_SAFE_INTEGER), (l[K][1] = 0));
              l.sort(me);
              ...
              for (let J = 0; J < 8; J++) {
                const Q = l[J],
                  $ = Q[0],
                  ee = Q[1];
                $ !== Number.MAX_SAFE_INTEGER && ee
                  ? (H && h.getAttribute('morphTarget' + J) !== H[$] && h.setAttribute('morphTarget' + J, H[$]),
                    W && h.getAttribute('morphNormal' + J) !== W[$] && h.setAttribute('morphNormal' + J, W[$]),
                    (a[J] = ee),
                    (q += ee))
                  : (H && !0 === h.hasAttribute('morphTarget' + J) && h.deleteAttribute('morphTarget' + J),
                    W && !0 === h.hasAttribute('morphNormal' + J) && h.deleteAttribute('morphNormal' + J),
                    (a[J] = 0));
              }
              const j = h.morphTargetsRelative ? 1 : 1 - q;
              d.getUniforms().setValue(e, 'morphTargetBaseInfluence', j),
      ...
      function ft(e, t, i) {
        ...
        for (let e = 0; e !== n; ++e) i.setTexture2D(t[e] || ye, r[e]);
      }
      function mt(e, t, i) {
        const n = t.length,
          r = Ie(i, n);
        e.uniform1iv(this.addr, r);
        for (let e = 0; e !== n; ++e) i.setTexture3D(t[e] || be, r[e]);
      }
      function gt(e, t, i) {
        const n = t.length,
          r = Ie(i, n);
        e.uniform1iv(this.addr, r);
        for (let e = 0; e !== n; ++e) i.setTextureCube(t[e] || we, r[e]);
      }
      function _t(e, t, i) {
        const n = t.length,
          r = Ie(i, n);
        e.uniform1iv(this.addr, r);
        for (let e = 0; e !== n; ++e) i.setTexture2DArray(t[e] || Se, r[e]);
      }
      class vt {
        constructor(e, t, i) {
          (this.id = e),
      ...
      function Vt(e, t, i, r) {
        ...
        const c = (function (e) {
            ...
            return (
              e.shadowMapType === n._i
                ? (t = 'SHADOWMAP_TYPE_PCF')
                : e.shadowMapType === n.nt
                ? (t = 'SHADOWMAP_TYPE_PCF_SOFT')
                : e.shadowMapType === n.dw && (t = 'SHADOWMAP_TYPE_VSM'),
              t
            );
          })(i),
          h = (function (e) {
        ...
        i.isRawShaderMaterial
          ...
          : ((_ = [
            ...
            (v = [
              ...
              i.toneMapping !== n.uL ? Lt('toneMapping', i.toneMapping) : '',
              i.dithering ? '#define DITHERING' : '',
              i.opaque ? '#define OPAQUE' : '',
              A.encodings_pars_fragment,
              Ct('linearToOutputTexel', i.outputEncoding),
        ...
        if (
          ...
          void 0 !== i.index0AttributeName
            ? a.bindAttribLocation(g, 0, i.index0AttributeName)
            : !0 === i.morphTargets && a.bindAttribLocation(g, 0, 'position'),
          a.linkProgram(g),
          e.debug.checkShaderErrors)
        ) {
          const e = a.getProgramInfoLog(g).trim(),
            t = a.getShaderInfoLog(y).trim(),
      ...
      function Wt(e, t, i, r, a, s, o) {
        ...
        return {
          getParameters: function (s, l, h, g, _) {
            const v = g.fog,
              x = _.geometry,
              M = s.isMeshStandardMaterial ? g.environment : null,
              y = (s.isMeshStandardMaterial ? i : t).get(s.envMap || M),
              S = y && y.mapping === n.g8 ? y.image.height : null,
              b = m[s.type];
            ...
            return {
              ...
              outputEncoding: null === R ? e.outputEncoding : !0 === R.isXRRenderTarget ? R.texture.encoding : n.rn,
              map: !!s.map,
              matcap: !!s.matcap,
              envMap: !!y,
              ...
              objectSpaceNormalMap: s.normalMapType === n.PA,
              tangentSpaceNormalMap: s.normalMapType === n.IO,
              decodeVideoTexture: !!s.map && !0 === s.map.isVideoTexture && s.map.encoding === n.kn,
              clearcoat: N,
              ...
              opaque: !1 === s.transparent && s.blending === n.bd,
              alphaMap: !!s.alphaMap,
              alphaTest: I,
              ...
              toneMapping: s.toneMapped ? e.toneMapping : n.uL,
              physicallyCorrectLights: e.physicallyCorrectLights,
              premultipliedAlpha: s.premultipliedAlpha,
              doubleSided: s.side === n.eh,
              flipSided: s.side === n._L,
          ...
          acquireProgram: function (t, i) {
            ...
            return void 0 === n && ((n = new Vt(e, i, t, s)), h.push(n)), n;
          },
      ...
      function Zt() {
        ...
        return {
          get: function (t, i) {
            ...
            let r;
            return (
              void 0 === n ? ((r = new Yt()), e.set(t, [r])) : i >= n.length ? ((r = new Yt()), n.push(r)) : (r = n[i]),
              r
            );
          },
          dispose: function () {
          ...
          get: function (t) {
            ...
            switch (t.type) {
              case 'DirectionalLight':
                i = { direction: new a.P(), color: new T.I() };
                break;
              case 'SpotLight':
                i = {
                  position: new a.P(),
                ...
                break;
              case 'PointLight':
                i = { position: new a.P(), color: new T.I(), distance: 0, decay: 0 };
                break;
              case 'HemisphereLight':
                i = { direction: new a.P(), skyColor: new T.I(), groundColor: new T.I() };
                break;
              case 'RectAreaLight':
                i = { color: new T.I(), position: new a.P(), halfWidth: new a.P(), halfHeight: new a.P() };
            }
            return (e[t.id] = i), i;
          },
        };
      ...
      function $t(e, t) {
            ...
            return {
              get: function (t) {
                ...
                switch (t.type) {
                  case 'DirectionalLight':
                  case 'SpotLight':
                    i = { shadowBias: 0, shadowNormalBias: 0, shadowRadius: 1, shadowMapSize: new g.F() };
                    break;
                  case 'PointLight':
                    i = {
                      shadowBias: 0,
        ...
        for (let e = 0; e < 9; e++) r.probe.push(new a.P());
        const s = new a.P(),
          o = new m.y(),
          l = new m.y();
        return {
          setup: function (a, s) {
            ...
            for (let e = 0, t = a.length; e < t; e++) {
              ...
              if (t.isAmbientLight) (o += s.r * y * M), (l += s.g * y * M), (c += s.b * y * M);
              else if (t.isLightProbe) for (let e = 0; e < 9; e++) r.probe[e].addScaledVector(t.sh.coefficients[e], y);
                ...
                e.position.setFromMatrixPosition(t.matrixWorld),
                  e.color.copy(s).multiplyScalar(y * M),
                  (e.distance = S),
                ...
                const a = t.shadow;
                if (
                  (t.map && ((r.spotLightMap[v] = t.map), v++, a.updateMatrices(t), t.castShadow && x++),
                ...
                const e = i.get(t);
                if (
                  (e.color.copy(t.color).multiplyScalar(t.intensity * M),
                ...
                const e = i.get(t);
                e.skyColor.copy(t.color).multiplyScalar(y * M),
                  e.groundColor.copy(t.groundColor).multiplyScalar(y * M),
                  (r.hemi[f] = e),
                  f++;
              }
            }
            p > 0 &&
              (t.isWebGL2 || !0 === e.has('OES_texture_float_linear')
                ? ((r.rectAreaLTC1 = L.LTC_FLOAT_1), (r.rectAreaLTC2 = L.LTC_FLOAT_2))
                : !0 === e.has('OES_texture_half_float_linear') &&
                  ((r.rectAreaLTC1 = L.LTC_HALF_1), (r.rectAreaLTC2 = L.LTC_HALF_2))),
              (r.ambient[0] = o),
              (r.ambient[1] = l),
              (r.ambient[2] = c);
            const y = r.hash;
      ...
      function ti(e, t) {
        ...
        return {
          get: function (n) {
            ...
            return (
              void 0 === a
                ? ((s = new ei(e, t)), i.set(n, [s]))
                : r >= a.length
                ? ((s = new ei(e, t)), a.push(s))
                : (s = a[r]),
              s
            );
          },
      ...
      function ai(e, t, i) {
        ...
        const a = new g.F(),
          s = new g.F(),
          o = new _.L(),
          l = new ni({ depthPacking: n.mS }),
          c = new ri(),
          h = {},
          u = i.maxTextureSize,
          d = { 0: n._L, 1: n.Wl, 2: n.eh },
          p = new w.j({
            defines: { VSM_SAMPLES: 8 },
            uniforms: { shadow_pass: { value: null }, resolution: { value: new g.F() }, radius: { value: 4 } },
        ...
        const v = new M.u();
        v.setAttribute('position', new y.Tl(new Float32Array([-1, -1, 0.5, 3, -1, 0.5, -1, 3, 0.5]), 3));
        const x = new E.K(v, p),
          S = this;
        function b(i, n) {
          const r = t.update(x);
          p.defines.VSM_SAMPLES !== i.blurSamples &&
            ...
            (p.needsUpdate = !0),
            (m.needsUpdate = !0)),
            null === i.mapPass && (i.mapPass = new z.d(a.x, a.y)),
            ...
            e.clear(),
            e.renderBufferDirect(n, null, r, p, x, null),
            ...
            e.clear(),
            e.renderBufferDirect(n, null, r, m, x, null);
        }
        function T(t, i, r, a, s, o) {
          let u = null;
          const p = !0 === r.isPointLight ? t.customDistanceMaterial : t.customDepthMaterial;
          if (
            ((u = void 0 !== p ? p : !0 === r.isPointLight ? c : l),
          ...
          return (
            ...
            o === n.dw
              ? (u.side = null !== i.shadowSide ? i.shadowSide : i.side)
              : (u.side = null !== i.shadowSide ? i.shadowSide : d[i.side]),
        ...
        function A(i, a, s, o, l) {
          ...
          const c = i.children;
          for (let e = 0, t = c.length; e < t; e++) A(c[e], a, s, o, l);
        }
        (this.enabled = !1),
          (this.autoUpdate = !0),
          (this.needsUpdate = !1),
          (this.type = n._i),
          (this.render = function (t, i, l) {
            ...
            for (let c = 0, h = t.length; c < h; c++) {
              ...
              if (
                ...
                s.copy(d.mapSize),
                (a.x > u || a.y > u) &&
                  (a.x > u && ((s.x = Math.floor(u / f.x)), (a.x = s.x * f.x), (d.mapSize.x = s.x)),
                  a.y > u && ((s.y = Math.floor(u / f.y)), (a.y = s.y * f.y), (d.mapSize.y = s.y))),
                null === d.map)
              ) {
                const e = this.type !== n.dw ? { minFilter: n.Ty, magFilter: n.Ty } : {};
                (d.map = new z.d(a.x, a.y, e)),
              ...
              for (let e = 0; e < m; e++) {
                ...
                o.set(s.x * t.x, s.y * t.y, s.x * t.z, s.y * t.w),
                  ...
                  (r = d.getFrustum()),
                  A(i, l, d.camera, h, this.type);
              }
              !0 !== d.isPointLightShadow && this.type === n.dw && b(d, l), (d.needsUpdate = !1);
            }
            (S.needsUpdate = !1), e.setRenderTarget(c, h, d);
          });
      }
      function si(e, t, i) {
        const r = i.isWebGL2;
        ...
        -1 !== I.indexOf('WebGL')
          ? ((R = parseFloat(/^WebGL (\d)/.exec(I)[1])), (D = R >= 1))
          : -1 !== I.indexOf('OpenGL ES') && ((R = parseFloat(/^OpenGL ES (\d)/.exec(I)[1])), (D = R >= 2));
        let N = null,
          O = {};
        ...
        (k[3553] = V(3553, 3553, 1)),
          ...
          G(2884),
          j(n.jF);
        const W = { [n.bG]: 32774, [n.Wb]: 32778, [n.rO]: 32779 };
        if (r) (W[n.r_] = 32775), (W[n.Sm] = 32776);
        else {
        ...
        function j(t, i, r, a, s, o, l, c) {
          if (t !== n.jF) {
            if ((!1 === m && (G(3042), (m = !0)), t === n.X))
              (s = s || i),
                (o = o || r),
                (l = l || a),
                (i === v && s === y) || (e.blendEquationSeparate(W[i], W[s]), (v = i), (y = s)),
                (r === x && a === M && o === S && l === b) ||
                  (e.blendFuncSeparate(q[r], q[a], q[o], q[l]), (x = r), (M = a), (S = o), (b = l)),
                (g = t),
                (w = null);
            else if (t !== g || c !== w) {
              if (((v === n.bG && y === n.bG) || (e.blendEquation(32774), (v = n.bG), (y = n.bG)), c))
                switch (t) {
                  case n.bd:
              ...
              (x = null), (M = null), (S = null), (b = null), (g = t), (w = c);
            }
          } else !0 === m && (H(3042), (m = !1));
        }
        function X(t) {
        ...
        function Y(t) {
          t !== n.Pe
            ? (G(2884), t !== E && (t === n.tm ? e.cullFace(1029) : t === n.S2 ? e.cullFace(1028) : e.cullFace(1032)))
            : H(2884),
            (E = t);
        }
        function Z(t, i, n) {
        ...
        return {
          ...
          bindFramebuffer: function (t, i) {
            return (
              ...
              (u[t] = i),
              r && (36009 === t && (u[36160] = i), 36160 === t && (u[36009] = i)),
              !0)
            );
          },
          ...
          setMaterial: function (e, t) {
            ...
            t && (i = !i),
              X(i),
              e.blending === n.bd && !1 === e.transparent
                ? j(n.jF)
                : j(
                    e.blending,
                    e.blendEquation,
            ...
            o.setTest(r),
              ...
              !0 === e.alphaToCoverage ? G(32926) : H(32926);
          },
          setFlipSided: X,
          setCullFace: Y,
          ...
          bindTexture: function (t, i) {
            null === N && K();
            let n = O[N];
            void 0 === n && ((n = { type: void 0, texture: void 0 }), (O[N] = n)),
      ...
      var oi = i(4222);
      function li(e, t, i, a, s, o, l) {
        const c = s.isWebGL2,
          h = (s.maxTextures, s.maxCubemapSize),
          u = s.maxTextureSize,
          d = s.maxSamples,
        ...
        function w(i, r, a, s) {
          ...
          let l = r;
          return (
            6403 === r && (5126 === a && (l = 33326), 5131 === a && (l = 33325), 5121 === a && (l = 33321)),
            33319 === r && (5126 === a && (l = 33328), 5131 === a && (l = 33327), 5121 === a && (l = 33323)),
            6408 === r &&
              (5126 === a && (l = 34836),
              5131 === a && (l = 34842),
              5121 === a && (l = s === n.kn && !1 === o ? 35907 : 32856),
              32819 === a && (l = 32854),
              32820 === a && (l = 32855)),
        ...
        function T(e, t, i) {
          return !0 === S(e, i) || (e.isFramebufferTexture && e.minFilter !== n.Ty && e.minFilter !== n.we)
        ...
        function D(e, t) {
          ...
          i.activeTexture(33984 + t), i.bindTexture(3553, n.__webglTexture);
        }
        const R = { [n.rp]: 10497, [n.uW]: 33071, [n.Oo]: 33648 },
          I = { [n.Ty]: 9728, [n.YL]: 9984, [n.aH]: 9986, [n.we]: 9729, [n.qy]: 9985, [n.D1]: 9987 };
        function N(i, r, o) {
          if (
            (o
              ? (e.texParameteri(i, 10242, R[r.wrapS]),
                e.texParameteri(i, 10243, R[r.wrapT]),
                (32879 !== i && 35866 !== i) || e.texParameteri(i, 32882, R[r.wrapR]),
                e.texParameteri(i, 10240, I[r.magFilter]),
                e.texParameteri(i, 10241, I[r.minFilter]))
              : (e.texParameteri(i, 10242, 33071),
                e.texParameteri(i, 10243, 33071),
                (32879 !== i && 35866 !== i) || e.texParameteri(i, 32882, 33071),
                r.wrapS !== n.uW || (r.wrapT, n.uW),
                e.texParameteri(i, 10240, E(r.magFilter)),
                e.texParameteri(i, 10241, E(r.minFilter)),
                r.minFilter !== n.Ty && (r.minFilter, n.we)),
            ...
            (r.anisotropy > 1 || a.get(r).__currentAnisotropy) &&
              (e.texParameterf(i, o.TEXTURE_MAX_ANISOTROPY_EXT, Math.min(r.anisotropy, s.getMaxAnisotropy())),
        ...
        function O(t, i) {
          ...
          if (s !== t.__cacheKey) {
            void 0 === a[s] && ((a[s] = { texture: e.createTexture(), usedTimes: 0 }), l.memory.textures++, (n = !0)),
              a[s].usedTimes++;
            const r = a[t.__cacheKey];
            void 0 !== r && (a[t.__cacheKey].usedTimes--, 0 === r.usedTimes && L(i)),
              (t.__cacheKey = s),
        ...
        function z(t, r, a) {
          ...
          if (
            ...
            let a = M(r.image, t, !1, u);
            a = G(r, a);
            const d = y(a) || c,
              p = o.convert(r.format, r.encoding);
            let f,
              m = o.convert(r.type),
              g = w(r.internalFormat, p, m, r.encoding, r.isVideoTexture);
            N(s, r, d);
            const _ = r.mipmaps,
            ...
            if (r.isDepthTexture)
              (g = 6402),
                c
                  ? (g = r.type === n.Vz ? 36012 : r.type === n.JQ ? 33190 : r.type === n.wJ ? 35056 : 33189)
                  : (r.type, n.Vz),
                r.format === n.qk &&
                  6402 === g &&
                  r.type !== n.Ls &&
                  r.type !== n.JQ &&
                  ((r.type = n.JQ), (m = o.convert(r.type))),
                r.format === n.br &&
                  6402 === g &&
                  ((g = 34041), r.type !== n.wJ && ((r.type = n.wJ), (m = o.convert(r.type)))),
                x &&
                  (v
                    ? i.texStorage2D(3553, 1, g, a.width, a.height)
                    : i.texImage2D(3553, 0, g, a.width, a.height, 0, p, m, null));
              ...
              if (_.length > 0 && d) {
                ...
                for (let e = 0, t = _.length; e < t; e++)
                  (f = _[e]),
                    v
                      ? i.texSubImage2D(3553, e, 0, 0, f.width, f.height, p, m, f.data)
                      : i.texImage2D(3553, e, g, f.width, f.height, 0, p, m, f.data);
                r.generateMipmaps = !1;
              } else
                v
                  ? (x && i.texStorage2D(3553, E, g, a.width, a.height),
                    i.texSubImage2D(3553, 0, 0, 0, a.width, a.height, p, m, a.data))
                  : i.texImage2D(3553, 0, g, a.width, a.height, 0, p, m, a.data);
                  ...
                  r.format !== n.wk
                    ? null !== p &&
                      (v
                        ...
                        : i.compressedTexImage2D(3553, e, g, f.width, f.height, 0, f.data))
                    : v
                    ? i.texSubImage2D(3553, e, 0, 0, f.width, f.height, p, m, f.data)
                    : i.texImage2D(3553, e, g, f.width, f.height, 0, p, m, f.data);
            } else if (r.isDataArrayTexture)
              v
                ? (x && i.texStorage3D(35866, E, g, a.width, a.height, a.depth),
                  i.texSubImage3D(35866, 0, 0, 0, 0, a.width, a.height, a.depth, p, m, a.data))
                : i.texImage3D(35866, 0, g, a.width, a.height, a.depth, 0, p, m, a.data);
            else if (r.isData3DTexture)
              v
                ? (x && i.texStorage3D(32879, E, g, a.width, a.height, a.depth),
                  i.texSubImage3D(32879, 0, 0, 0, 0, a.width, a.height, a.depth, p, m, a.data))
                : i.texImage3D(32879, 0, g, a.width, a.height, a.depth, 0, p, m, a.data);
            else if (r.isFramebufferTexture) {
              if (x)
                if (v) i.texStorage2D(3553, E, g, a.width, a.height);
                else {
                  let e = a.width,
                    t = a.height;
                  for (let n = 0; n < E; n++) i.texImage2D(3553, n, g, e, t, 0, p, m, null), (e >>= 1), (t >>= 1);
                }
            } else if (_.length > 0 && d) {
              v && x && i.texStorage2D(3553, E, g, _[0].width, _[0].height);
              for (let e = 0, t = _.length; e < t; e++)
                (f = _[e]), v ? i.texSubImage2D(3553, e, 0, 0, p, m, f) : i.texImage2D(3553, e, g, p, m, f);
              r.generateMipmaps = !1;
            } else
              v
                ? (x && i.texStorage2D(3553, E, g, a.width, a.height), i.texSubImage2D(3553, 0, 0, 0, p, m, a))
                : i.texImage2D(3553, 0, g, p, m, a);
            S(r, d) && b(s), (h.__currentVersion = h.version), r.onUpdate && r.onUpdate(r);
          }
          t.__version = r.version;
        }
        function U(t, n, r, s, l) {
          const c = o.convert(r.format, r.encoding),
            h = o.convert(r.type),
            u = w(r.internalFormat, c, h, r.encoding);
          a.get(n).__hasExternalTextures ||
            (32879 === l || 35866 === l
              ? i.texImage3D(l, 0, u, n.width, n.height, n.depth, 0, c, h, null)
              : i.texImage2D(l, 0, u, n.width, n.height, 0, c, h, null)),
            i.bindFramebuffer(36160, t),
            k(n)
              ? p.framebufferTexture2DMultisampleEXT(36160, s, l, a.get(r).__webglTexture, 0, V(n))
              : e.framebufferTexture2D(36160, s, l, a.get(r).__webglTexture, 0),
        ...
        function F(t, i, r) {
          if ((e.bindRenderbuffer(36161, t), i.depthBuffer && !i.stencilBuffer)) {
            ...
            if (r || k(i)) {
              ...
              const r = V(i);
              k(i)
                ? p.renderbufferStorageMultisampleEXT(36161, r, a, i.width, i.height)
            ...
            const n = V(i);
            r && !1 === k(i)
              ? e.renderbufferStorageMultisample(36161, n, 35056, i.width, i.height)
              : k(i)
              ? p.renderbufferStorageMultisampleEXT(36161, n, 35056, i.width, i.height)
            ...
            for (let n = 0; n < t.length; n++) {
              const a = t[n],
                s = o.convert(a.format, a.encoding),
                l = o.convert(a.type),
                c = w(a.internalFormat, s, l, a.encoding),
                h = V(i);
              r && !1 === k(i)
                ? e.renderbufferStorageMultisample(36161, h, c, i.width, i.height)
                : k(i)
                ? p.renderbufferStorageMultisampleEXT(36161, h, c, i.width, i.height)
          ...
          if (t.depthTexture && !r.__autoAllocateDepthBuffer) {
            ...
            !(function (t, r) {
              ...
              const s = a.get(r.depthTexture).__webglTexture,
                o = V(r);
              if (r.depthTexture.format === n.qk)
                k(r)
                  ? p.framebufferTexture2DMultisampleEXT(36160, 36096, 3553, s, 0, o)
                  : e.framebufferTexture2D(36160, 36096, 3553, s, 0);
              else {
                if (r.depthTexture.format !== n.br) throw new Error('Unknown depthTexture format');
                k(r)
                  ? p.framebufferTexture2DMultisampleEXT(36160, 33306, 3553, s, 0, o)
        ...
        function k(e) {
          const i = a.get(e);
          return (
            c && e.samples > 0 && !0 === t.has('WEBGL_multisampled_render_to_texture') && !1 !== i.__useRenderToTexture
          );
        }
        function G(e, i) {
          const r = e.encoding,
          ...
          return (
            !0 === e.isCompressedTexture ||
              ...
              (r !== n.rn &&
                r === n.kn &&
                (!1 === c
                  ? !0 === t.has('EXT_sRGB') && a === n.wk
                    ? ((e.format = n.L_), (e.minFilter = n.we), (e.generateMipmaps = !1))
                    : (i = oi.P.sRGBToLinear(i))
                  : a !== n.wk || n.yw)),
            i
          );
        }
        (this.allocateTextureUnit = function () {
          ...
          (this.setTexture2DArray = function (e, t) {
            ...
            e.version > 0 && n.__version !== e.version
              ? z(n, e, t)
              : (i.activeTexture(33984 + t), i.bindTexture(35866, n.__webglTexture));
          }),
          (this.setTexture3D = function (e, t) {
            const n = a.get(e);
            e.version > 0 && n.__version !== e.version
              ? z(n, e, t)
              : (i.activeTexture(33984 + t), i.bindTexture(32879, n.__webglTexture));
          }),
              ...
              ? (function (t, r, a) {
                  ...
                  if (
                    ...
                    const t = r.isCompressedTexture || r.image[0].isCompressedTexture,
                      a = r.image[0] && r.image[0].isDataTexture,
                      u = [];
                    for (let e = 0; e < 6; e++)
                      (u[e] = t || a ? (a ? r.image[e].image : r.image[e]) : M(r.image[e], !1, !0, h)),
                        (u[e] = G(r, u[e]));
                    const d = u[0],
                      p = y(d) || c,
                      ...
                      for (let e = 0; e < 6; e++) {
                        ...
                        for (let t = 0; t < x.length; t++) {
                          ...
                          r.format !== n.wk
                            ? null !== f &&
                              (_
                                ? i.compressedTexSubImage2D(34069 + e, t, 0, 0, a.width, a.height, f, a.data)
                                : i.compressedTexImage2D(34069 + e, t, g, a.width, a.height, 0, a.data))
                            : _
                            ? i.texSubImage2D(34069 + e, t, 0, 0, a.width, a.height, f, m, a.data)
                            : i.texImage2D(34069 + e, t, g, a.width, a.height, 0, f, m, a.data);
                        }
                      }
                    } else {
                      (x = r.mipmaps),
                        _ && v && (x.length > 0 && E++, i.texStorage2D(34067, E, g, u[0].width, u[0].height));
                      for (let e = 0; e < 6; e++)
                        if (a) {
                          _
                            ? i.texSubImage2D(34069 + e, 0, 0, 0, u[e].width, u[e].height, f, m, u[e].data)
                            : i.texImage2D(34069 + e, 0, g, u[e].width, u[e].height, 0, f, m, u[e].data);
                          for (let t = 0; t < x.length; t++) {
                            const n = x[t].image[e].image;
                            _
                              ? i.texSubImage2D(34069 + e, t + 1, 0, 0, n.width, n.height, f, m, n.data)
                              : i.texImage2D(34069 + e, t + 1, g, n.width, n.height, 0, f, m, n.data);
                          }
                        } else {
                          _
                            ? i.texSubImage2D(34069 + e, 0, 0, 0, f, m, u[e])
                            : i.texImage2D(34069 + e, 0, g, f, m, u[e]);
                          for (let t = 0; t < x.length; t++) {
                            const n = x[t];
                            _
                              ? i.texSubImage2D(34069 + e, t + 1, 0, 0, f, m, n.image[e])
                              : i.texImage2D(34069 + e, t + 1, g, f, m, n.image[e]);
                          }
                        }
                    }
                    S(r, p) && b(34067), (l.__currentVersion = l.version), r.onUpdate && r.onUpdate(r);
                  }
                  t.__version = r.version;
                })(s, t, r)
            ...
            if (u) {
              ...
              if (c && t.samples > 0 && !1 === k(t)) {
                ...
                for (let i = 0; i < a.length; i++) {
                  const n = a[i];
                  (r.__webglColorRenderbuffer[i] = e.createRenderbuffer()),
                    e.bindRenderbuffer(36161, r.__webglColorRenderbuffer[i]);
                  const s = o.convert(n.format, n.encoding),
                    l = o.convert(n.type),
                    c = w(n.internalFormat, s, l, n.encoding),
                    h = V(t);
                  e.renderbufferStorageMultisample(36161, h, c, t.width, t.height),
                    e.framebufferRenderbuffer(36160, 36064 + i, 36161, r.__webglColorRenderbuffer[i]);
                }
                e.bindRenderbuffer(36161, null),
                  t.depthBuffer &&
                    ((r.__webglDepthRenderbuffer = e.createRenderbuffer()), F(r.__webglDepthRenderbuffer, t, !0)),
                  i.bindFramebuffer(36160, null);
              }
            }
            if (u) {
              i.bindTexture(34067, h.__webglTexture), N(34067, n, p);
              for (let e = 0; e < 6; e++) U(r.__webglFramebuffer[e], t, n, 36064, 34069 + e);
              ...
              for (let n = 0, s = e.length; n < s; n++) {
                const s = e[n],
                  o = a.get(s);
                i.bindTexture(3553, o.__webglTexture),
                  N(3553, s, p),
                  U(r.__webglFramebuffer, t, s, 36064 + n, 3553),
                  S(s, p) && b(3553);
              }
              i.unbindTexture();
            } else {
              ...
              (t.isWebGL3DRenderTarget || t.isWebGLArrayRenderTarget) &&
                ...
                N(e, n, p),
                U(r.__webglFramebuffer, t, n, 36064, e),
                S(n, p) && b(e),
                i.unbindTexture();
            }
            t.depthBuffer && B(t);
            ...
            if (c && t.samples > 0 && !1 === k(t)) {
              ...
              for (let i = 0; i < n.length; i++) {
                ...
                if (
                  ...
                  u && e.framebufferRenderbuffer(36008, 36064, 36161, h.__webglColorRenderbuffer[i]),
                ...
                e.blitFramebuffer(0, 0, r, s, 0, 0, r, s, o, 9728), f && e.invalidateFramebuffer(36008, l);
              }
      ...
      function ci(e, t, i) {
        ...
        return {
          convert: function (i) {
            ...
            if (i === n.cL)
              return r ? 5131 : ((a = t.get('OES_texture_half_float')), null !== a ? a.HALF_FLOAT_OES : null);
            ...
            if (i === n.wu || i === n.BF || i === n.v3 || i === n.IL)
              if (s === n.kn) {
            ...
            if (i === n.ft)
              return (a = t.get('WEBGL_compressed_texture_etc1')), null !== a ? a.COMPRESSED_RGB_ETC1_WEBGL : null;
            if (i === n.l0 || i === n.ek) {
            ...
            if (
              ...
              if (i === n.pt)
                return s === n.kn ? a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR : a.COMPRESSED_RGBA_ASTC_4x4_KHR;
              if (i === n.jZ)
                return s === n.kn ? a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR : a.COMPRESSED_RGBA_ASTC_5x4_KHR;
              if (i === n.y2)
                return s === n.kn ? a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR : a.COMPRESSED_RGBA_ASTC_5x5_KHR;
              if (i === n.gi)
                return s === n.kn ? a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR : a.COMPRESSED_RGBA_ASTC_6x5_KHR;
              if (i === n.Dj)
                return s === n.kn ? a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR : a.COMPRESSED_RGBA_ASTC_6x6_KHR;
              if (i === n.BG)
                return s === n.kn ? a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR : a.COMPRESSED_RGBA_ASTC_8x5_KHR;
              if (i === n.NY)
                return s === n.kn ? a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR : a.COMPRESSED_RGBA_ASTC_8x6_KHR;
              if (i === n.xJ)
                return s === n.kn ? a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR : a.COMPRESSED_RGBA_ASTC_8x8_KHR;
              if (i === n.pK)
                return s === n.kn ? a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR : a.COMPRESSED_RGBA_ASTC_10x5_KHR;
              if (i === n.GG)
                return s === n.kn ? a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR : a.COMPRESSED_RGBA_ASTC_10x6_KHR;
              if (i === n.Gi)
                return s === n.kn ? a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR : a.COMPRESSED_RGBA_ASTC_10x8_KHR;
              if (i === n.FU)
                return s === n.kn ? a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR : a.COMPRESSED_RGBA_ASTC_10x10_KHR;
              if (i === n.ii)
                return s === n.kn ? a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR : a.COMPRESSED_RGBA_ASTC_12x10_KHR;
              if (i === n.Sv)
                return s === n.kn ? a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR : a.COMPRESSED_RGBA_ASTC_12x12_KHR;
            }
            if (i === n.bs) {
              if (((a = t.get('EXT_texture_compression_bptc')), null === a)) return null;
              if (i === n.bs)
                return s === n.kn ? a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT : a.COMPRESSED_RGBA_BPTC_UNORM_EXT;
            }
            return i === n.wJ
              ? r
                ? 34042
      ...
      class mi extends k.x {
        constructor(e, t, i, r, a, s, o, l, c, h) {
          if ((h = void 0 !== h ? h : n.qk) !== n.qk && h !== n.br)
            throw new Error('DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat');
          void 0 === i && h === n.qk && (i = n.JQ),
            void 0 === i && h === n.br && (i = n.wJ),
            super(null, r, a, s, o, l, h, i, c),
        ...
        constructor(e, t) {
          ...
          function P(e) {
            for (let t = 0; t < e.removed.length; t++) {
              const i = e.removed[t],
                n = y.indexOf(i);
              n >= 0 && ((y[n] = null), M[n].dispatchEvent({ type: 'disconnected', data: i }));
            }
              ...
              if (((r = a), null !== r)) {
                if (
                  ...
                  (p = new XRWebGLLayer(r, t, i)),
                    ...
                    (x = new z.d(p.framebufferWidth, p.framebufferHeight, {
                      format: n.wk,
                      type: n.yw,
                  ...
                  let i = null,
                    ...
                    o = null;
                  m.depth &&
                    ((o = m.stencil ? 35056 : 33190), (i = m.stencil ? n.br : n.qk), (a = m.stencil ? n.wJ : n.JQ));
                  const l = { colorFormat: 32856, depthFormat: o, scaleFactor: s };
                  (u = new XRWebGLBinding(r, t)),
                    (d = u.createProjectionLayer(l)),
                    r.updateRenderState({ layers: [d] }),
                    (x = new z.d(d.textureWidth, d.textureHeight, {
                      format: n.wk,
                      type: n.yw,
                      depthTexture: new mi(
                        d.textureWidth,
          ...
          (this.updateCamera = function (e) {
            if (null === r) return;
            (T.near = b.near = S.near = e.near),
              (T.far = b.far = S.far = e.far),
              (E === T.near && A === T.far) ||
                (r.updateRenderState({ depthNear: T.near, depthFar: T.far }), (E = T.near), (A = T.far));
            const t = e.parent,
              i = T.cameras;
            I(T, t);
          ...
          O.setAnimationLoop(function (t, i) {
            if (((h = i.getViewerPose(c || o)), (f = i), null !== h)) {
              ...
              for (let n = 0; n < t.length; n++) {
                ...
                let s = w[n];
                void 0 === s && ((s = new F.c()), s.layers.enable(n), (s.viewport = new _.L()), (w[n] = s)),
        ...
        function i(i, r) {
          (i.opacity.value = r.opacity),
            ...
            r.bumpMap &&
              ...
              r.side === n._L && (i.bumpScale.value *= -1)),
            r.displacementMap &&
            ...
            r.normalMap &&
              ...
              r.side === n._L && i.normalScale.value.negate()),
          ...
          let s, o;
          r.aoMap && ((i.aoMap.value = r.aoMap), (i.aoMapIntensity.value = r.aoMapIntensity)),
            r.map
              ? (s = r.map)
              : r.specularMap
              ? (s = r.specularMap)
              ...
              ? (s = r.clearcoatNormalMap)
              : r.clearcoatRoughnessMap
              ? (s = r.clearcoatRoughnessMap)
              : r.iridescenceMap
              ? (s = r.iridescenceMap)
              : r.iridescenceThicknessMap
              ? (s = r.iridescenceThicknessMap)
              : r.specularIntensityMap
              ? (s = r.specularIntensityMap)
              : r.specularColorMap
              ? (s = r.specularColorMap)
              : r.transmissionMap
              ? (s = r.transmissionMap)
              : r.thicknessMap
              ? (s = r.thicknessMap)
              : r.sheenColorMap
              ? (s = r.sheenColorMap)
              : r.sheenRoughnessMap && (s = r.sheenRoughnessMap),
            void 0 !== s &&
                  ...
                  (function (e, t, i) {
                    ...
                    t.clearcoat > 0 &&
                      ...
                      t.clearcoatNormalMap &&
                        ...
                        t.side === n._L && e.clearcoatNormalScale.value.negate()));
                    t.iridescence > 0 &&
              ...
              (!(function (e) {
                ...
                for (let e = 0, a = t.length; e < a; e++) {
                  const a = t[e],
                    s = c(a);
                  if (
                    ((a.__data = new Float32Array(s.storage / Float32Array.BYTES_PER_ELEMENT)), (a.__offset = i), e > 0)
                  ) {
                    r = i % n;
                    const e = n - r;
                ...
                for (let t = 0, i = n.length; t < i; t++) {
                  ...
                  if (!0 === l(i, t, a)) {
                    const t = i.value,
                      n = i.__offset;
                    'number' == typeof t
                      ? ((i.__data[0] = t), e.bufferSubData(35345, n, i.__data))
                      : (i.value.isMatrix3
      ...
      function Mi() {
        ...
        const t = void 0 !== e.canvas ? e.canvas : xi(),
        ...
        try {
          ...
          if (
            ('setAttribute' in t && t.setAttribute('data-engine', `three.js r${n.UZ}`),
            ...
            if ((!0 === w.isWebGL1Renderer && t.shift(), (Oe = ze(t, e)), null === Oe))
              throw ze(t)
        ...
        function Ue() {
          (re = new ce(Oe)),
            ...
            (oe = new pe(Oe)),
            (he = new qt()),
            (fe = new li(Oe, re, se, he, ae, Re, oe)),
            (me = new W(w)),
            (ge = new le(w)),
            (xe = new x(Oe, ae)),
            (Ie = new R(Oe, re, xe, ae)),
            (Me = new ue(Oe, xe, oe, Ie)),
            (ye = new ve(Oe, Me, xe, oe)),
            (Le = new _e(Oe, ae, fe)),
            (Ee = new O(he)),
            (Se = new Wt(w, me, ge, re, ae, Ie, Ee)),
            (be = new _i(w, he)),
            (we = new Zt()),
            (Te = new ti(re, ae)),
            (Ce = new D(w, me, se, ye, p, c)),
            (Ae = new ai(w, ye, ae)),
            (Ne = new vi(Oe, oe, ae, se)),
            (Pe = new I(Oe, re, oe, ae)),
            (De = new de(Oe, re, oe, ae)),
            (oe.programs = Se.programs),
            (w.capabilities = ae),
            (w.extensions = re),
            (w.properties = he),
            (w.renderLists = we),
        ...
        (this.xr = Fe),
          ...
          (this.setViewport = function (e, t, i, n) {
            e.isVector4 ? j.set(e.x, e.y, e.z, e.w) : j.set(e, t, i, n),
              se.viewport(U.copy(j).multiplyScalar(G).floor());
          }),
          ...
          (this.setScissor = function (e, t, i, n) {
            e.isVector4 ? X.set(e.x, e.y, e.z, e.w) : X.set(e, t, i, n),
              se.scissor(F.copy(X).multiplyScalar(G).floor());
          }),
          ...
          (this.dispose = function () {
            t.removeEventListener('webglcontextlost', Be, !1),
              ...
              Se.dispose(),
              Fe.dispose(),
              Fe.removeEventListener('sessionstart', Xe),
              Fe.removeEventListener('sessionend', Ye),
              Q && (Q.dispose(), (Q = null)),
              Ze.stop();
          }),
          (this.renderBufferDirect = function (e, t, i, n, r, a) {
            ...
            let h,
              u = 1;
            !0 === n.wireframe && ((l = Me.getWireframeAttribute(i)), (u = 2)), Ie.setup(r, n, o, i, l);
            let d = Pe;
            null !== l && ((h = xe.get(l)), (d = De), d.setIndex(h));
            const p = null !== l ? l.count : c.count,
              ...
              v = Math.max(f, g),
              x = Math.min(p, f + m, g + _) - 1,
              M = Math.max(0, x - v + 1);
            if (0 !== M) {
              if (r.isMesh)
                !0 === n.wireframe ? (se.setLineWidth(n.wireframeLinewidth * ne()), d.setMode(1)) : d.setMode(4);
              else if (r.isLine) {
                let e = n.linewidth;
                void 0 === e && (e = 1),
              ...
              if (r.isInstancedMesh) d.renderInstances(v, M, r.count);
          ...
          if (e.layers.test(t.layers))
            if (e.isGroup) i = e.renderOrder;
              ...
              (e.isSkinnedMesh &&
                ...
                (e.skeleton.update(), (e.skeleton.frame = oe.render.frame)),
              ...
              } else r.visible && M.push(e, t, r, i, te.z, null);
            }
          const r = e.children;
          for (let e = 0, a = r.length; e < a; e++) Ke(r[e], t, i, n);
        }
        function Je(e, t, i, n) {
          const r = e.opaque,
            a = e.transmissive,
        ...
        function Qe(e, t, i) {
          ...
          null === Q &&
            (Q = new z.d(1, 1, {
              generateMipmaps: !0,
              type: re.has('EXT_color_buffer_half_float') ? n.cL : n.yw,
              minFilter: n.D1,
              samples: a && !0 === l ? 4 : 0,
            })),
            w.getDrawingBufferSize(ee),
            a ? Q.setSize(ee.x, ee.y) : Q.setSize((0, r.gy)(ee.x), (0, r.gy)(ee.y));
        ...
        function et(e, t, i, r, a, s) {
          e.onBeforeRender(w, t, i, r, a, s),
            e.modelViewMatrix.multiplyMatrices(i.matrixWorldInverse, e.matrixWorld),
            e.normalMatrix.getNormalMatrix(e.modelViewMatrix),
            a.onBeforeRender(w, t, i, r, e, s),
            !0 === a.transparent && a.side === n.eh
              ? ((a.side = n._L),
                (a.needsUpdate = !0),
                w.renderBufferDirect(i, t, r, a, e, s),
                (a.side = n.Wl),
                (a.needsUpdate = !0),
                w.renderBufferDirect(i, t, r, a, e, s),
                (a.side = n.eh))
              : w.renderBufferDirect(i, t, r, a, e, s),
            e.onAfterRender(w, t, i, r, a, s);
        }
        function tt(e, t, i) {
          !0 !== t.isScene && (t = ie);
          const n = he.get(e),
            ...
            s = r.state.version,
            o = Se.getParameters(e, r.state, a, t, i),
            l = Se.getProgramCacheKey(o);
          let c = n.programs;
          (n.environment = e.isMeshStandardMaterial ? t.environment : null),
            (n.fog = t.fog),
            (n.envMap = (e.isMeshStandardMaterial ? ge : me).get(e.envMap || n.environment)),
            void 0 === c && (e.addEventListener('dispose', Ge), (c = new Map()), (n.programs = c));
          let h = c.get(l);
          if (void 0 !== h) {
        ...
        function nt(e, t, i, r, a) {
          ...
          const s = t.fog,
            ...
            l = null === C ? w.outputEncoding : !0 === C.isXRRenderTarget ? C.texture.encoding : n.rn,
            c = (r.isMeshStandardMaterial ? ge : me).get(r.envMap || o),
            h = !0 === r.vertexColors && !!i.attributes.color && 4 === i.attributes.color.itemSize,
            u = !!r.normalMap && !!i.attributes.tangent,
            d = !!i.morphAttributes.position,
            p = !!i.morphAttributes.normal,
            f = !!i.morphAttributes.color,
            m = r.toneMapped ? w.toneMapping : n.uL,
          ...
          r.version === v.__version
            ? (v.needsLights && v.lightsStateVersion !== x.state.version) ||
              ...
              ? a.isSkinnedMesh && !1 === v.skinning
                ...
                ? v.envMap !== c || (!0 === r.fog && v.fog !== s)
                  ? (M = !0)
                  : void 0 === v.numClippingPlanes ||
                    (v.numClippingPlanes === Ee.numPlanes && v.numIntersection === Ee.numIntersection)
                  ? (v.vertexAlphas !== h ||
                      v.vertexTangents !== u ||
                      v.morphTargets !== d ||
                      v.morphNormals !== p ||
                      v.morphColors !== f ||
                      v.toneMapping !== m ||
                      (!0 === ae.isWebGL2 && v.morphTargetsCount !== _)) &&
                    (M = !0)
                  : (M = !0)
                : (M = !0)
              : (M = !0)
            : ((M = !0), (v.__version = r.version));
          ...
          const A = S.getUniforms(),
            D = v.uniforms;
          if (
            (se.useProgram(S.program) && ((b = !0), (T = !0), (E = !0)),
            r.id !== L && ((L = r.id), (T = !0)),
            b || P !== e)
          ) {
            if (
              (A.setValue(Oe, 'projectionMatrix', e.projectionMatrix),
              ae.logarithmicDepthBuffer && A.setValue(Oe, 'logDepthBufFC', 2 / (Math.log(e.far + 1) / Math.LN2)),
              P !== e && ((P = e), (T = !0), (E = !0)),
              r.isShaderMaterial ||
                r.isMeshPhongMaterial ||
                r.isMeshToonMaterial ||
            ...
            (r.isMeshPhongMaterial ||
              ...
              r.isMeshStandardMaterial ||
              r.isShaderMaterial) &&
              A.setValue(Oe, 'isOrthographic', !0 === e.isOrthographicCamera),
              (r.isMeshPhongMaterial ||
                r.isMeshToonMaterial ||
                r.isMeshLambertMaterial ||
                r.isMeshBasicMaterial ||
                ...
                r.isShadowMaterial ||
                a.isSkinnedMesh) &&
                A.setValue(Oe, 'viewMatrix', e.matrixWorldInverse);
          }
          if (a.isSkinnedMesh) {
            ...
            e &&
              ...
              A.setValue(Oe, 'boneTexture', e.boneTexture, fe),
              A.setValue(Oe, 'boneTextureSize', e.boneTextureSize));
          }
          const R = i.morphAttributes;
          if (
            ((void 0 !== R.position || void 0 !== R.normal || (void 0 !== R.color && !0 === ae.isWebGL2)) &&
              Le.update(a, i, r, S),
            (T || v.receiveShadow !== a.receiveShadow) &&
              ((v.receiveShadow = a.receiveShadow), A.setValue(Oe, 'receiveShadow', a.receiveShadow)),
            r.isMeshGouraudMaterial &&
              null !== r.envMap &&
              ((D.envMap.value = c), (D.flipEnvMap.value = c.isCubeTexture && !1 === c.isRenderTargetTexture ? -1 : 1)),
            T &&
              (A.setValue(Oe, 'toneMappingExposure', w.toneMappingExposure),
              v.needsLights && rt(D, E),
              s && !0 === r.fog && be.refreshFogUniforms(D, s),
              be.refreshMaterialUniforms(D, r, G, k, Q),
              wt.upload(Oe, v.uniformsList, D, fe)),
            r.isShaderMaterial &&
              !0 === r.uniformsNeedUpdate &&
              (wt.upload(Oe, v.uniformsList, D, fe), (r.uniformsNeedUpdate = !1)),
            r.isSpriteMaterial && A.setValue(Oe, 'center', a.center),
            A.setValue(Oe, 'modelViewMatrix', a.modelViewMatrix),
            A.setValue(Oe, 'normalMatrix', a.normalMatrix),
            A.setValue(Oe, 'modelMatrix', a.matrixWorld),
        ...
        Ze.setAnimationLoop(je),
          ...
          Fe.addEventListener('sessionstart', Xe),
          Fe.addEventListener('sessionend', Ye),
          (this.render = function (e, t) {
            ...
            !0 === e.matrixWorldAutoUpdate && e.updateMatrixWorld(),
              ...
              !0 === e.isScene && e.onBeforeRender(w, e, t, C),
              (y = Te.get(e, b.length)),
              y.init(),
              b.push(y),
              $.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse),
              Z.setFromProjectionMatrix($),
              (J = this.localClippingEnabled),
              (K = Ee.init(this.clippingPlanes, J, t)),
              (M = we.get(e, S.length)),
              M.init(),
              S.push(M),
              Ke(e, t, 0, w.sortObjects),
              M.finish(),
              !0 === w.sortObjects && M.sort(H, q),
              !0 === K && Ee.beginShadows();
            ...
            null !== C && (fe.updateMultisampleRenderTarget(C), fe.updateRenderTargetMipmap(C)),
            ...
            (n.__hasExternalTextures = !0),
              n.__hasExternalTextures &&
                ...
                n.__autoAllocateDepthBuffer ||
                  (!0 === re.has('WEBGL_multisampled_render_to_texture') && (n.__useRenderToTexture = !1)));
          }),
          ...
          (this.setRenderTarget = function (e) {
            ...
            if (e) {
              ...
              void 0 !== t.__useDefaultFramebuffer
                ? (se.bindFramebuffer(36160, null), (n = !1))
                : void 0 === t.__webglFramebuffer
                ? fe.setupRenderTarget(e)
                : t.__hasExternalTextures &&
                  fe.rebindTextures(e, he.get(e.texture).__webglTexture, he.get(e.depthTexture).__webglTexture);
            }
            let r = null,
              a = !1,
              s = !1;
            if (e) {
              ...
              e.isWebGLCubeRenderTarget
                ? ((r = n[t]), (a = !0))
                : (r =
                    ae.isWebGL2 && e.samples > 0 && !1 === fe.useMultisampledRTT(e)
                      ? he.get(e).__webglMultisampledFramebuffer
                      : n),
                U.copy(e.viewport),
                F.copy(e.scissor),
                (B = e.scissorTest);
            } else U.copy(j).multiplyScalar(G).floor(), F.copy(X).multiplyScalar(G).floor(), (B = Y);
            const o = se.bindFramebuffer(36160, r);
            if (
              (o && ae.drawBuffers && n && se.drawBuffers(e, r), se.viewport(U), se.scissor(F), se.setScissorTest(B), a)
            ) {
          ...
          (this.readRenderTargetPixels = function (e, t, i, r, a, s, o) {
            ...
            if ((e.isWebGLCubeRenderTarget && void 0 !== o && (l = l[o]), l)) {
              ...
              try {
                ...
                const h =
                  c === n.cL &&
                  (re.has('EXT_color_buffer_half_float') || (ae.isWebGL2 && re.has('EXT_color_buffer_float')));
                if (
                  !(
                    c === n.yw ||
                    Re.convert(c) === Oe.getParameter(35738) ||
                    (c === n.Vz &&
                      (ae.isWebGL2 || re.has('OES_texture_float') || re.has('WEBGL_color_buffer_float'))) ||
                    h
                  )
                )
                  return;
                t >= 0 &&
                  ...
                  i >= 0 &&
                  i <= e.height - a &&
                  Oe.readPixels(t, i, r, a, Re.convert(l), Re.convert(c), s);
              } finally {
          ...
          (this.copyTextureToTexture = function (e, t, i) {
            ...
            const r = t.image.width,
              a = t.image.height,
              s = Re.convert(i.format),
              o = Re.convert(i.type);
            fe.setTexture2D(i, 0),
              Oe.pixelStorei(37440, i.flipY),
              Oe.pixelStorei(37441, i.premultiplyAlpha),
              Oe.pixelStorei(3317, i.unpackAlignment),
              t.isDataTexture
                ? Oe.texSubImage2D(3553, n, e.x, e.y, r, a, s, o, t.image.data)
                ...
                : Oe.texSubImage2D(3553, n, e.x, e.y, s, o, t.image),
              0 === n && i.generateMipmaps && Oe.generateMipmap(3553),
              se.unbindTexture();
          }),
          (this.copyTextureToTexture3D = function (e, t, i, n) {
            let r = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 0;
            if (w.isWebGL1Renderer) return;
            const a = e.max.x - e.min.x + 1,
              s = e.max.y - e.min.y + 1,
              o = e.max.z - e.min.z + 1,
              l = Re.convert(n.format),
              c = Re.convert(n.type);
            let h;
            ...
            Oe.pixelStorei(37440, n.flipY),
              Oe.pixelStorei(37441, n.premultiplyAlpha),
              Oe.pixelStorei(3317, n.unpackAlignment);
            ...
            Oe.pixelStorei(3314, g.width),
              Oe.pixelStorei(32878, g.height),
              Oe.pixelStorei(3316, e.min.x),
              Oe.pixelStorei(3315, e.min.y),
              Oe.pixelStorei(32877, e.min.z),
              i.isDataTexture || i.isData3DTexture
                ? Oe.texSubImage3D(h, r, t.x, t.y, t.z, a, s, o, l, c, g.data)
                : i.isCompressedTexture
                ? Oe.compressedTexSubImage3D(h, r, t.x, t.y, t.z, a, s, o, l, g.data)
                : Oe.texSubImage3D(h, r, t.x, t.y, t.z, a, s, o, l, c, g),
              Oe.pixelStorei(3314, u),
              Oe.pixelStorei(32878, d),
              Oe.pixelStorei(3316, p),
              Oe.pixelStorei(3315, f),
              Oe.pixelStorei(32877, m),
    ...
    7526: (e, t, i) => {
      ...
      i.d(t, { Rh: () => r, dw: () => n, fd: () => a, rD: () => s });
      const s = { clone: n, merge: r };
    },
    4567: (e, t, i) => {
      i.d(t, { x: () => r });
      var n = i(3740);
      ...
      class a {
        ...
        toJSON(e) {
          ...
          if (null !== n) {
            ...
            if (Array.isArray(n)) {
              e = [];
              for (let t = 0, i = n.length; t < i; t++) n[t].isDataTexture ? e.push(s(n[t].image)) : e.push(s(n[t]));
            } else e = s(n);
            i.url = e;
          }
    ...
    2887: (e, t, i) => {
      ...
      class h extends n.p {
        constructor() {
          let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : h.DEFAULT_IMAGE,
            t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : h.DEFAULT_MAPPING,
            i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : r.uW,
            n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : r.uW,
            u = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : r.we,
            d = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : r.D1,
            p = arguments.length > 6 && void 0 !== arguments[6] ? arguments[6] : r.wk,
            f = arguments.length > 7 && void 0 !== arguments[7] ? arguments[7] : r.yw,
            m = arguments.length > 8 && void 0 !== arguments[8] ? arguments[8] : 1,
            g = arguments.length > 9 && void 0 !== arguments[9] ? arguments[9] : r.rn;
          super(),
            (this.isTexture = !0),
      ...
      (h.DEFAULT_IMAGE = null), (h.DEFAULT_MAPPING = r.xf);
    },
    4361: (e, t, i) => {
      i.d(t, { f: () => a });
      var n = i(1700),
      ...
      class a extends r.x {
        constructor(e, t, i, r, a, s, o, l, c) {
          super(e, t, i, r, a, s, o, l, c),
            (this.isVideoTexture = !0),
            (this.minFilter = void 0 !== s ? s : n.we),
            (this.magFilter = void 0 !== a ? a : n.we),
            (this.generateMipmaps = !1);
          const h = this;
